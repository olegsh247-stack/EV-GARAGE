...
export const brands: Brand[] = [
  {
    ...
    models: [
      ...
      },
      {
        slug: "zeekr-007",
        name: "Zeekr 007",
        tagline: "Спортивный седан на 800В платформе",
        bodyType: "Седан",
        seats: 5,
        description:
          "Спортивный электроседан Zeekr на 800-вольтовой платформе PMA2 — делит технику с Geely Galaxy E8. Один из самых быстрозаряжаемых седанов в классе.",
        trims: [
          {
            slug: "rwd",
            name: "RWD",
      ...
      },
      {
        slug: "zeekr-7x",
        name: "Zeekr 7X",
        tagline: "Кроссовер на платформе SEA/PMA2",
        bodyType: "Кроссовер",
        seats: 5,
        description:
          "Кроссовер-версия Zeekr 007, построена на той же 800-вольтовой платформе. Один из самых продаваемых Zeekr на глобальных рынках.",
        trims: [
          {
            slug: "rwd",
            name: "RWD",
  ...
  },
  {
    ...
    models: [
      ...
      },
      {
        ...
        seats: 5,
        description:
          "Оригинальный флагманский седан NIO — до 150 кВт·ч батареи и запаса хода свыше 1000 км, полный набор автопилота Aquila с 33 сенсорами.",
        trims: [
          {
            slug: "100kwh",
            name: "100 кВт·ч",
          ...
          },
          {
            ...
            topSpeedKmh: 200,
            batteryKwh: 150,
            batteryType: "NMC (полутвердотельная)",
      ...
      },
      {
        slug: "nio-es8",
        name: "NIO ES8",
        tagline: "Флагманский SUV на 6-7 мест",
        bodyType: "Полноразмерный SUV",
        seats: 6,
        description:
          "Новое поколение флагманского SUV NIO — сейчас главный продукт бренда по продажам. Доступен в 6- и 7-местной конфигурации.",
        trims: [
          {
            slug: "standart",
            name: "Стандарт",
  ...
  },
  {
    ...
    models: [
      ...
      },
      {
        ...
        seats: 5,
        description:
          "Спортивный седан BYD на платформе e-Platform 3.0 с батареей Blade, встроенной в силовую структуру кузова (CTB-технология).",
        trims: [
          {
            slug: "premium",
            name: "Premium",
            ...
            fastCharge: "~30 мин (10→80%)",
            drive: "Задний",
            highlight: "Задний привод, максимальный запас хода",
          },
          {
            slug: "performance",
            name: "Performance",
      ...
      },
      {
        slug: "byd-atto-3",
        name: "BYD Atto 3",
        tagline: "Компактный кроссовер (Yuan Plus)",
        bodyType: "Кроссовер",
        seats: 5,
        description:
          "Один из самых массовых электрокроссоверов BYD в мире, известен на домашнем рынке как Yuan Plus. Фирменный «гитарный» декор в дверных нишах.",
        trims: [
          {
            slug: "standart",
            name: "Стандарт",
      ...
      },
      {
        slug: "byd-dolphin",
        name: "BYD Dolphin",
        tagline: "Городской электрохэтчбек",
        bodyType: "Хэтчбек",
        seats: 5,
        description:
          "Компактный доступный хэтчбек BYD с фирменным дизайном «в стиле дельфина» — одна из самых продаваемых моделей бренда в мире.",
        trims: [
          {
            slug: "standart",
            name: "Стандарт",
          ...
          },
          {
            ...
            fastCharge: "~30 мин (10→80%)",
            drive: "Передний",
            highlight: "Увеличенная батарея и мощность",
          },
        ],
      },
    ],
  ...
  },
  {
    ...
    models: [
      ...
      },
      {
        slug: "xpeng-mona-m03",
        name: "Xpeng Mona M03",
        tagline: "Самая продаваемая модель Xpeng",
        bodyType: "Лифтбек",
        seats: 5,
        description:
          "Доступный электролифтбек, разработанный совместно с Didi — бестселлер Xpeng, обеспечивающий больше 40% продаж бренда.",
        trims: [
          {
            slug: "515",
            name: "515",
          ...
          },
          {
            ...
            fastCharge: "~28 мин (10→80%)",
            drive: "Передний",
            highlight: "Увеличенная батарея, топовое оснащение",
          },
        ],
      },
      {
        ...
        seats: 5,
        description:
          "Спортивный электроседан второго поколения на платформе SEPA 2.0 — поддерживает сверхбыструю 5C-зарядку.",
        trims: [
          {
            slug: "rwd",
            name: "RWD",
  ...
  },
  {
    ...
    models: [
      ...
      },
      {
        slug: "li-l7",
        name: "Li Auto L7",
        tagline: "Самый популярный SUV линейки Li Auto",
        bodyType: "SUV",
        seats: 5,
        description:
          "Пятиместная версия успешной формулы Li Auto: электропривод с бензиновым генератором для увеличения запаса хода.",
        trims: [
          {
            slug: "pro",
            name: "Pro",
            ...
            fastCharge: "~20 мин (10→80%)",
            drive: "Полный",
            highlight: "210 км на электротяге + генератор — общий запас свыше 1300 км",
          },
        ],
      },
    ],
  },
  {
    ...
    models: [
      ...
      },
      {
        slug: "leapmotor-t03",
        name: "Leapmotor T03",
        tagline: "Мини-электромобиль класса A00",
        bodyType: "Хэтчбек",
        seats: 4,
        description:
          "Компактный доступный электромобиль, продаётся уже в 20+ странах мира — один из самых успешных бюджетных электромобилей Leapmotor.",
        trims: [
          {
            slug: "310",
            name: "310",
      ...
      },
      {
        slug: "leapmotor-b10",
        name: "Leapmotor B10",
        tagline: "Компактный кроссовер, бестселлер бренда",
        bodyType: "Кроссовер",
        seats: 5,
        description:
          "Новый компактный кроссовер Leapmotor — один из самых быстрорастущих по продажам продуктов бренда, уже поставляется и в Латинскую Америку.",
        trims: [
          {
            slug: "standart",
            name: "Стандарт",
          ...
          },
          {
            ...
            fastCharge: "~30 мин (10→80%)",
            drive: "Задний",
            highlight: "Расширенное оснащение",
          },
        ],
      },
    ],
  },
  {
    ...
    models: [
      ...
      },
      {
        slug: "aion-s",
        name: "GAC Aion S",
        tagline: "Популярный электроседан",
        bodyType: "Седан",
        seats: 5,
        description:
          "Один из самых массовых электроседанов GAC Aion — часто используется в такси и каршеринге благодаря надёжности и запасу хода.",
        trims: [
          {
            slug: "510",
            name: "510",
  ...
  },
  {
    ...
    models: [
      ...
      },
      {
        slug: "voyah-passion",
        name: "Voyah Passion",
        tagline: "Премиальный электроседан с автопилотом Huawei",
        bodyType: "Седан",
        seats: 5,
        description:
          "Электроседан Voyah с системой автопилота Huawei ADS и продвинутыми лидарными датчиками.",
        trims: [
          {
            slug: "standart",
            name: "Стандарт",
  ...
  },
  {
    ...
    models: [
      ...
      },
      {
        slug: "hongqi-eh7",
        name: "Hongqi EH7",
        tagline: "Представительский электроседан",
        bodyType: "Седан",
        seats: 5,
        description:
          "Более премиальный седан Hongqi — бренда, который традиционно поставляет автомобили для официальных лиц Китая.",
        trims: [
          {
            slug: "standart",
            name: "Стандарт",
  ...
  },
  {
    ...
    models: [
      ...
      },
      {
        slug: "xiaomi-yu7",
        name: "Xiaomi YU7",
        tagline: "Второй электромобиль Xiaomi — премиальный SUV",
        bodyType: "Кроссовер",
        seats: 5,
        description:
          "Электрический кроссовер Xiaomi на 800-вольтовой платформе, прямой конкурент Tesla Model Y. Запущен в июне 2025 года и сразу стал одним из хитов продаж бренда.",
        trims: [
          {
            slug: "standart",
            name: "Стандарт",
